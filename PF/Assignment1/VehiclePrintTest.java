...
public class VehiclePrintTest {

	@Test
	// tests attributes of car class
	public void testCarAttributes() {
		Vehicle vehicleObj = VehicleHelper.createVehicle("Car", "Make2",
				"Model2");
		String strOutput = VehiclePrinter.printVehicleSpecification(vehicleObj);
	...
	public void testBikeAttributes() {
		Vehicle vehicleObj = VehicleHelper.createVehicle("Bike", "Make3",
				"Model3");
		String strOutput = VehiclePrinter.printVehicleSpecification(vehicleObj);
	...
	public void testEqualsAndHashcodeForVehiclePositive() {
		Vehicle vehicleObj1 = VehicleHelper.createVehicle("Car", "Make1",
				"Model1");
		Vehicle vehicleObj2 = VehicleHelper.createVehicle("Bike", "Make2",
				"Model2");
		Vehicle vehicleObj3 = VehicleHelper.createVehicle("Car", "Make3",
				"Model3");
		Vehicle vehicleObj4 = VehicleHelper.createVehicle("Bike", "Make2",
				"Model4");
		Vehicle vehicleObj5 = VehicleHelper.createVehicle("Car", "Make1",
				"Model1");
		// set stores vehicles
	...
	public void testEqualsAndHashcodeForCarPositive() {
		Vehicle vehicleObj1 = VehicleHelper.createVehicle("Car", "Make1",
				"Model1");
		Vehicle vehicleObj2 = VehicleHelper.createVehicle("Car", "Make2",
				"Model2");
		Vehicle vehicleObj3 = VehicleHelper.createVehicle("Car", "Make3",
				"Model3");
		Vehicle vehicleObj4 = VehicleHelper.createVehicle("Car", "Make2",
				"Model4");
		Vehicle vehicleObj5 = VehicleHelper.createVehicle("Car", "Make1",
				"Model1");
		// set stores vehicles
	...
	public void testEqualsAndHashcodeForBikePositive() {
		Vehicle vehicleObj1 = VehicleHelper.createVehicle("Bike", "Make1",
				"Model1");
		Vehicle vehicleObj2 = VehicleHelper.createVehicle("Bike", "Make2",
				"Model2");
		Vehicle vehicleObj3 = VehicleHelper.createVehicle("Bike", "Make3",
				"Model3");
		Vehicle vehicleObj4 = VehicleHelper.createVehicle("Bike", "Make2",
				"Model4");
		Vehicle vehicleObj5 = VehicleHelper.createVehicle("Bike", "Make1",
				"Model1");
		// set stores vehicles
		Set<Vehicle> vehicleSet = new HashSet<Vehicle>();
		vehicleSet.add(vehicleObj1);
