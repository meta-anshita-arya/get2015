...
public class FCFSprg {
	...
	public static void main(String arg[]) {
		...
		FCFSprg assign = new FCFSprg();
		System.out
				.println(" job job arrival Time Job Waiting Time Job Start Time Job Finish Time");
		for (int i = 0; i < n; i++) {
			for (int j = 0; j < 5; j++) {
				System.out
						.print(assign.FCFS(Arrival_time, Job_size, n).clone()[i][j]
								+ " ");
			}
			System.out.println();
		}
