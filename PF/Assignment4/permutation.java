...
public class permutation {
	...
	String generatePermutations(String beginningString, String endingString)            //recursive function to perform permutation of string
	{
	...
	result=result+" "+beginningString+endingString;
	    ...
	    for (int i = 0; i < endingString.length(); i++)
	    {
	      try 
	      {
	   	  ...
	   	  generatePermutations(beginningString + endingString.charAt(i), newString);             //recursive calling of function
	      } 
