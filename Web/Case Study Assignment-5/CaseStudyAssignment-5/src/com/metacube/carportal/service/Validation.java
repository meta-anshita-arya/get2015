...
public class Validation {
	 ...
	 * @return :message
	 */
	public static String validationOnCarDetails(String make, String model,
			String engineInCC, String fuelCapacity, String milage,
			String price, String roadTax) {
		...
		if (engineInCC.equals(null) || engineInCC.equals("")) {
			flag = 1;
			message += "EngineInCC field Empty<br>";
			// Validations for Fuel Capacity
		}
		if (fuelCapacity.equals(null) || fuelCapacity.equals("")) {
			flag = 1;
			message += "FuelCapacity field Empty<br>";
			// Validations for Milage
		}
		if (milage.equals(null) || milage.equals("")) {
			flag = 1;
