...
public class JacksonMapper {
	...
	public static void toJava() {
		...
		try {
			File json = new File("emp.json");

			Employee employee1 = mapper.readValue(json, Employee.class);
			System.out.println("Java object created from JSON String :");
			System.out.println(employee1.employeeName);
			System.out.println(employee1.employee_id);
			System.out.println(employee1.date_Of_Birth);
	...
	public static void toJSON() {
		Employee employee = new Employee("Anshita", 12, "anshi@gmail.com",
				"3-08-2015");
