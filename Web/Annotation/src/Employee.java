...
/**
 * @author Anshita ---This class inherits the annotation in its functions
 */
public class Employee {
	 ...
	 *            ---string variable taken by annotation default value
	 */
	@RequestForEnhancement(id = 1, synopsis = "Anshita")
	 ...
	 *            ---string variable taken by annotation
	 */
	@RequestForEnhancement(id = 1, synopsis = "Anshita", engineer = "software", date = "10/14/2015")
